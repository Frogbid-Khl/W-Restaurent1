    ...
    <div class="page-content bg-white container-fluid">
     ...
     <!--   <section class="section-wrapper-5 content-inner justify-content-center overflow-hidden  mt-lg-5 " style="background-image:url('assets/images/background/pic1.png')  ;  ">
            <div class="container">
                ...
                <div>
                    <h6 class="text-white">PRESENTATION   </h6>  <p class="text-white">The combination of vessels and dishes highlight the value and beauty of Chinese ingredients.   </p>
                    <h6 class="text-white">CONCEPT    </h6>  <p class="text-white">   Instilling new elements to reactivate Chinese cuisine without deviating from the manifesto of traditional Chinese culinary art. </p>
                    <h6 class="text-white">EXPERIENCE     </h6>  <p class="text-white">     Dining is more than the need of human but an enjoyment and interaction.Chinesology features a series of especial dining experience such as four hands dinner and cocktail pairing dinner, bringing memorable moments to guests!
                    </p>
                    <h6 class="text-white">  OFFERINGS     </h6>  <p class="text-white">      To prepare cuisines with finest ingredients with integration of five elements of Chinese cosmology.</p>
                </div>
