    ...
    <div class="page-content bg-white">
        ...
        <section class="section-wrapper-8 content-inner-1">
            <div class="container">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-6 col-lg-9">
                        ...
                        <ul style="line-height: 40px; font-size: 20px;">
                            ...
                            <li><i class="fa-solid fa-calendar-days"></i> Mon-Fri: 11:00 - 21:30 | Sat-Sun, PH: 10:00 - 21:30</li>
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-6 col-lg-9">
                        ...
                        <ul style="line-height: 40px; font-size: 20px;">
                            ...
                            <li><i class="fa-solid fa-calendar-days"></i> Mon-Fri: 10:45 - 23:00 | Sat-Sun: 10:00 - 23:00</li>
                ...
                <div class="row mt-3">
                    <div class="col-12 text-center">
                        <h2>For franchising enquiry, please contact us via xxxx@buick-hk.com</h2>
                    </div>
                </div>
            </div>
        </section>
